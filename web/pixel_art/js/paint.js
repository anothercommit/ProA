...
mostrar_grilla.addEventListener("change", function () {
	if (this.checked) {
		casillas.forEach((item) => item.classList.add("mostrar-grilla"));
	} else {
		casillas.forEach((item) => item.classList.remove("mostrar-grilla"));
	}
});
