...
document.getElementById("aclaracion").innerHTML =
  `El tamaño por defecto del laberinto es de ${tamaño} * ${tamaño}. Lo puede cambiar en la primera variable global.`;
...
function crearLaberinto(y = 1, x = 1, midY = 1, midX = 1) {
  ...
  while (direcciones.length > 0) {
    ...
    crearLaberinto(direccion.y, direccion.x, direccion.midY, direccion.midX);
